...
<html lang="en" class="light-style " dir="ltr" data-theme="theme-default" data-assets-path="{{url('public')}}/" data-template="horizontal-menu-template">
<head>
    <meta charset="utf-8" />
  ...
  <div class="misc-wrapper">
    <div class="app-brand mb-2">
          <a href="{{url('/')}}" class="app-brand-link gap-2">
           <img src="{{asset('public/assets/img/logo2.png')}}" style="width: 150px;">
          </a>
        </div>
    ...
    <div class="mt-3">
      <img src="{{asset('public/assets/img/illustrations/page-misc-error-light.png')}}" alt="page-misc-error-light" width="500" class="img-fluid" >
    </div>
  </div>
</div>
<!-- /Error -->
...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/horizontal-menu-template/pages-misc-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jun 2022 10:19:58 GMT -->
</html>
