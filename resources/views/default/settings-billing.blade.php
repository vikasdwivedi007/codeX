            ...
            <div class="timeline-event">
              ...
              <div class="d-flex">
                <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                  <img src="{{asset('public/assets/img/icons/misc/pdf.png')}}" alt="PDF image" width="23" class="me-2">
            ...
            <table class="table table-borderless text-nowrap">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/chrome.png')}}" alt="Chrome" height="24" class="me-2">
                      <span>Chrome</span>
                    </div>
                  </td>
                  <td>8.92k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/safari.png')}}" alt="Safari" height="24" class="me-2">
                      <span>Safari</span>
                    </div>
                  </td>
                  <td>7.29k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/firefox.png')}}" alt="Firefox" height="24" class="me-2">
                      <span>Firefox</span>
                    </div>
                  </td>
                  <td>6.11k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/edge.png')}}" alt="Edge" height="24" class="me-2">
                      <span>Edge</span>
                    </div>
                  </td>
                  <td>5.08k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/opera.png')}}" alt="Opera" height="24" class="me-2">
                      <span>Opera</span>
                    </div>
                  </td>
                  <td>3.93k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/brave.png')}}" alt="Brave" height="24" class="me-2">
                      <span>Brave</span>
                    </div>
                  </td>
                  <td>3.19k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/vivaldi.png')}}" alt="Vivaldi" height="24" class="me-2">
                      <span>Vivaldi</span>
                    </div>
                  </td>
                  <td>1.29k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/uc.png')}}" alt="UC Browser" height="24" class="me-2">
            ...
            <table class="table table-borderless">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/windows.png')}}" alt="Windows" height="24" class="me-2">
                      <span>Windows</span>
                    </div>
                  </td>
                  <td>875.24k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/mac.png')}}" alt="Mac" height="24" class="me-2">
                      <span>Mac</span>
                    </div>
                  </td>
                  <td>89.68k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/ubuntu.png')}}" alt="Ubuntu" height="24" class="me-2">
                      <span>Ubuntu</span>
                    </div>
                  </td>
                  <td>37.68k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/cent.png')}}" alt="Cent" height="24" class="me-2">
                      <span>Cent</span>
                    </div>
                  </td>
                  <td>32.25k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/linux.png')}}" alt="Linux" height="24" class="me-2">
                      <span>Linux</span>
                    </div>
                  </td>
                  <td>22.15k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/fedora.png')}}" alt="Fedora" height="24" class="me-2">
                      <span>Fedora</span>
                    </div>
                  </td>
                  <td>1.13k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{asset('public/assets/img/icons/brands/vivaldi-os.png')}}" alt="Vivaldi" height="24" class="me-2">
                      <span>Vivaldi</span>
                    </div>
                  </td>
                  <td>1.09k</td>
