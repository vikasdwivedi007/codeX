	    				...
	    				<div class="card">
	    					<div class="card-header">
	    						<ul class="nav nav-pills card-header-pills" role="tablist" style="margin-left: -1.28rem;">
	    							...
	    							<li class="nav-item">
	    								<button type="button" class="nav-link active" role="tab" id="survey_tab" data-bs-toggle="tab" data-bs-target="#navs-pills-within-card-link" aria-controls="navs-survey-link" aria-selected="false">Survey</button>
	    							</li>
	    							<li class="nav-item">
	    								<a class="nav-link" id="new_parts" href="{{url('interim/new-parts')}}">New Parts</a>
	    							</li>
	    							<li class="nav-item">
	    											...
	    											<div class="row">
	    												...
	    												<div class="col-md-12 col-lg-12">
	    													<div class="mb-3">
	    														...
	    														<textarea class="form-control ckeditor" name="causes_nature_accident" id="ckeditor"></textarea>
	    														<p class="error" id="err_causes_nature_accident"></p>
	    													</div>
	    												</div>
